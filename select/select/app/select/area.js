class Area {
     ...
     constructor(cssclass,manager){
        ...
        manager.setFinishCallback(this.#finishCallback());
     }
...
class DeckArea extends Area{
    ...
    #nextCardCallback(){
        return answer => {
            ...
            cardElement.addEventListener('click', this.#clickOnCardOrSkip())
...
class SolutionArea extends Area{
    ...
    constructor(cssClass, manager){
        super(cssClass, manager);
        this.manager.setAppendCardToSolutionCallback(answer => {
